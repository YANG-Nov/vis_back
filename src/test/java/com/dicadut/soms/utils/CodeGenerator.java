package com.dicadut.soms.utils;
...
public class CodeGenerator {
    ...
    public void run() {
        ...
        gc.setOutputDir(projectPath + "/src/main/java");    //生成路径，写成绝对路径
        ...
        pc.setModuleName("soms"); //模块名
        pc.setParent("com.dicadut");
