...
public class MobileRealm extends AuthenticatingRealm {
    ...
    protected AuthenticationInfo doGetAuthenticationInfo(AuthenticationToken token) throws AuthenticationException {
        ...
        UserPermissionVO user = userService.queryUserByMobile(userName);
        //国弱没有查到
        if (null == user){
        ...
        SimpleAuthenticationInfo simpleAuthenticationInfo = new SimpleAuthenticationInfo(user,user.getUserPass(),salt,getName());
