...
public class Task {
    ...
    private String taskType;   // TODO 樊乾玉: 改成String类型, Integer的最大值有上限，很容易就超过上限，后续没法扩展
    ...
    private String taskStatus; // TODO 樊乾玉: 改成String类型, Integer的最大值有上限，很容易就超过上限，后续没法扩展
