...
public class Task {
    ...
    @ApiModelProperty(value = "任务状态:1002000001 待领取 1002000002 进行中 1002000003 待审核 10020000004 待分配 10020000005 " +
            "待重传 10020000006 巡检完成 10020000007 自动召回 10020000008 主动召回 10020000010 待巡检 10020000010 待确认")
